...
sayHelloButton.addEventListener("mouseover", backgroundChange)
// PROBLEM 3
/*
...
const repeatMyParam = () => {
    //YOUR CODE HERE
axios.get('http://localhost:3000/repeat/lion')
.then(response => {
...
/*
    ...
    2: Send more than 1 query on the URL -- what happened? Status 200
*/
...
/*
function createFood () {
        let foodInput=document.querySelectorAll('#food');
        let body = {
            newFood, foodInput,
        }
...
document.querySelectorAll('#food').addEventListener('click', createFood)
//let form = document.querySelector('form')//a function needs to happen in form
*/
